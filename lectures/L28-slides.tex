...
\title{Lecture 28 --- Scheduling Algorithms}
...
\begin{center}
	\includegraphics[width=\slidewidth]{images/geringverdiener.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.5\slidewidth]{images/dmv.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.9\slidewidth]{images/fcfs-1.png}
\end{center}

Total time: 30 units. Average completion time: 27 units.
\begin{center}
	\includegraphics[width=0.9\slidewidth]{images/fcfs-2.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.5\slidewidth]{images/roundrobin.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.75\slidewidth]{images/virtualrobin.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.65\slidewidth]{images/virtual-round-robin.png}.
\end{center}
...
\begin{center}
	\includegraphics[width=0.65\slidewidth]{images/quick-adventure.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.5\slidewidth]{images/quick-update.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.4\slidewidth]{images/redpanda.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.7\slidewidth]{images/sjf.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.5\slidewidth]{images/exponential-averaging.png}
\end{center}
...
\begin{center}
\includegraphics[width=\slidewidth]{images/sjf-2.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.7\slidewidth]{images/stay-on-target.jpg}
\end{center}
