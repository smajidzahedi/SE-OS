...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/2docs.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.6\textwidth]{images/process-switch.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.45\textwidth]{images/desktop-shortcut.jpg}
	\end{center}
	\begin{center}
		\tiny Image Credit: CS Tigers
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.65\textwidth]{images/walking-dead.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.3\textwidth]{images/judgement-day.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.8\textwidth]{images/5-state-model.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.8\textwidth]{images/7-state-model.png}
	\end{center}
