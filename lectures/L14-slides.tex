...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/texting.jpeg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.3\textwidth]{images/nasa-rendezvous.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/waiting-in-line.jpg}
	\end{center}
...
\begin{frame}[fragile]
	...
	The general form in pseudocode for \texttt{mutex} semaphore (i.e., semaphore initialized to 1) is of course:
...
\begin{frame}
	...
	In addition to the mutex semaphore, we also discussed the general semaphore.
...
\begin{frame}
	...
	A potential solution is to protect all database accesses with a mutex semaphore, so only one database query can run at any time.
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/fence-barrier.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/nyc-subway-turnstile.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.8\textwidth]{images/reusable-barrier.png}
	\end{center}
