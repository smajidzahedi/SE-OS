...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.2\textwidth]{images/keepback.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/order.jpg}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.3\textwidth]{images/sass1.png}\\
		\includegraphics[width=0.3\textwidth]{images/sass2.png}
	\end{center}
...
\begin{frame}
	\frametitle{Safe/Unsafe}
	\begin{center}
		\includegraphics[width=0.45\textwidth]{images/safe}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.2\textwidth]{images/safe-state-initial.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/safe-state.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.4\textwidth]{images/unsafe-state-initial.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
	\includegraphics[width=0.3\textwidth]{images/danger.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/sherlock-wall.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.2\textwidth]{images/resource-allocation-graph-claim.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.3\textwidth]{images/monopoly-man.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.3\textwidth]{images/unsafe-state-initial.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.45\textwidth]{images/bankers-multiple.png}
	\end{center}
