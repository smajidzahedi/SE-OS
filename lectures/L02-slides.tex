...
Some operations are only available in supervisor mode.\\
...
If I order a book from Ottawa, it takes a long time to arrive.
...
When an interrupt takes place, the CPU might ignore it (rarely).

\begin{center}
	\includegraphics[width=0.4\textwidth]{images/imbusy.jpg}
\end{center}
...
Analogy: professor in a lecture; a student has a question.
...
\begin{center}
	\includegraphics[width=0.45\textwidth]{images/rememberthings.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.3\textwidth]{images/why-not-zoidberg.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.3\textwidth]{images/delegate.jpg}
\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.65\textwidth]{images/itsatrap.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.3\textwidth]{images/spiderman.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
	\includegraphics[width=0.6\textwidth]{images/worldif.jpg}
	\end{center}
