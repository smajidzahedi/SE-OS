...
%
%	\begin{center}
%		\includegraphics[width=0.25\textwidth]{images/file.png}
%	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.6\textwidth]{images/FS-layout.png}
	\end{center}
	\begin{center}
		\tiny Image Credit: \texttt{serverkaka.com}
	\end{center}
...
\begin{frame}
	...
	\end{center}
	\begin{center}
		\tiny Image credit: \href{https://stackoverflow.com/questions/21113919/difference-between-r-and-w-in-fopen}{stackoverflow}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.35\textwidth]{images/delete.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.1\textwidth]{images/file-lock}
	\end{center}
...
\begin{frame}
	...
	The system will work out that we need to start from the current directory (e.g., \texttt{/home/se350/}) and prepend that to the given file name.

	This produces the absolute path of \texttt{/home/se350/code/example.c}.
...
\begin{frame}
	...
	So if a symbolic link is created to a file like \texttt{/Users/se350/file.txt}, the symbolic link will just be a ``shortcut'' to that file.
