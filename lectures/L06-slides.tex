...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.4\textwidth]{images/24-splitscreen.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.55\textwidth]{images/thanks-captain-obvious}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/shared-mem.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/file-sys}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/msg-pass}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.4\textwidth]{images/seenmeme.jpeg}
	\end{center}
...
\begin{center}
	\includegraphics[width=0.5\textwidth]{images/pass-message.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.3\textwidth]{images/message-passing.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.25\textwidth]{images/zoolander.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.25\textwidth]{images/yesbutno.jpg}
\end{center}
