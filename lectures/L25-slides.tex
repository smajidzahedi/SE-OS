...
\title{Lecture 25 --- Virtual Memory}
...
\begin{center}
	\includegraphics[width=\slidewidth]{images/limit.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.5\slidewidth]{images/goodnews.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.85\slidewidth]{images/vmem-physmem.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.4\slidewidth]{images/thrashing2.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\slidewidth]{images/handling-page-fault.png}
\end{center}
