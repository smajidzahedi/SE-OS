...
\title{Lecture 23 --- Memory: Segmentation \& Paging }
...
\begin{center}
	\includegraphics[width=\slidewidth]{images/pov.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.4\slidewidth]{images/segfault.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.55\slidewidth]{images/segments.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.75\slidewidth]{images/segmentation-hardware.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.5\slidewidth]{images/pictureframe.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.6\slidewidth]{images/loading-pages.png}
\end{center}
...
\begin{center}
\includegraphics[width=\slidewidth]{images/page-tables.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.65\slidewidth]{images/page-table-mapping.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.5\slidewidth]{images/explained.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.4\slidewidth]{images/frametable.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.8\slidewidth]{images/datacentre.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\slidewidth]{images/tlb-hardware.png}
\end{center}
