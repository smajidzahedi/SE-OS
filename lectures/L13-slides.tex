...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.75\textwidth]{images/springfield-plant.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/semaphore-signals.jpg}
	\end{center}
	\begin{center}
		\tiny Image Credit: Wikipedia user Denelson83
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.25\textwidth]{images/starbucks.jpg}
	\end{center}
	\begin{center}
		\tiny Image Credit: Brandt Kofton
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.3\textwidth]{images/nopeeking.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.2\textwidth]{images/linkedlist1.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.25\textwidth]{images/linkedlist2.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.25\textwidth]{images/linkedlist3.png}
	\end{center}
