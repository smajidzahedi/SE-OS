...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.5\textwidth]{images/mario-pipe.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/unix-pipe.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.25\textwidth]{images/shared-memory.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/detach-cable.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.6\textwidth]{images/worldmap.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.25\textwidth]{images/AllesVerboten.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/memory-mapped-file.png}
	\end{center}
...
\begin{frame}[fragile]
	...
	\begin{center}
		\includegraphics[width=0.2\textwidth]{images/sync-icon.png}
	\end{center}
