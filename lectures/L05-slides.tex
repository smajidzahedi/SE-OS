...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/linux-process-tree.pdf}
	\end{center}
...
\begin{frame}
	...
	\quad You get presented with the prompt again (e.g., \texttt{se350@Loki:\~{}/\$}).
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.3\textwidth]{images/spiderman-2.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.65\textwidth]{images/forkbomb.png}
	\end{center}
	\begin{center}
		\tiny Image Credit: Wikipedia user Dake
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/beacon_gondor.png}
	\end{center}
