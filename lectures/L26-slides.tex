...
\title{Lecture 26 --- Virtual Memory II }
...
\begin{center}
	\includegraphics[width=0.3\slidewidth]{images/pages-elsewhere.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.3\slidewidth]{images/allmine.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.5\slidewidth]{images/reservation.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.75\slidewidth]{images/architecture.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.5\slidewidth]{images/bargain.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.7\slidewidth]{images/global-local.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=0.4\slidewidth]{images/backtowork.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.75\slidewidth]{images/thrashing.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.55\slidewidth]{images/locality.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.75\slidewidth]{images/workingset.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.75\slidewidth]{images/explorenearby.jpg}
\end{center}
