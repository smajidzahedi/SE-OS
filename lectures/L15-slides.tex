...
\begin{frame}
	\frametitle{Monitors}
	\begin{center}
		\includegraphics[width=0.45\textwidth]{images/monitor.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.35\textwidth]{images/monday.png}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.5\textwidth]{images/newsanchor.jpg}
...
\begin{frame}[fragile]
	...
	\begin{center}
		\includegraphics[width=0.45\textwidth]{images/looper.jpg}
	\end{center}
...
\begin{frame}[fragile]
	...
	\begin{center}
		\includegraphics[width=0.3\textwidth]{images/icecream}
	\end{center}
...
\begin{frame}[fragile]
	\frametitle{Broadcast Barrier ({\color{red} Fixed})}
...
11. lock( mutex )
12. done++
\textcolor{red}{13. if done == n}
\textcolor{red}{14.    count = 0}
\textcolor{red}{15.    done = 0}
\textcolor{red}{16. end if}
17. unlock( mutex )
  				\end{Verbatim}
			\end{multicols}
		}
